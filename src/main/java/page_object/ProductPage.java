...
public class ProductPage {
    ...
    public ProductPage addProductToCart(){
        ...
        assertThat(driver.findElement(SUCCESS_MESSAGE_ELEMENT).getText(),
                containsString(String.format(PRODUCT_ADDED_TO_CART,
                SharedContext.getValue(StaticKeys.CURRENT_ITEM))));
